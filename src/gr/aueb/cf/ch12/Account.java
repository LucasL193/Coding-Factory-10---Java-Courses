...
public class Account {
     ...
     * @throws Exception if the amount is negative, the balance is insufficient or the SSN does not match.
     */
    ...
    public void withdraw(double amount, String ssn) throws Exception {
        try {
            ...
            if (!isSsnValid(ssn)) throw new Exception("SSN does not match");
            balance -= amount;
        } catch (Exception e) {
            System.err.printf("Withdraw failed. \n%s\n", e.getMessage());
            throw e;
        }
    }
