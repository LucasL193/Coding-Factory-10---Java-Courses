 ...
 * πρόσθεση, αφαίρεση, πολ/σμό, διαίρεση και mod, o
 * χρήστης επιλέγει, στη συνέχεια δίνει τις τιμές εισόδου,
 * και λαμβάνει το αποτέλεσμα. Αυτό επαναλαμβάνεται μέχρι ο χρήστης
 * να επιλέξει 'έξοδο'.
 */
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if (!isChoiceValid(choice)){
                System.out.println("Μη έγκυρη επιλογή. Παρακαλώ προσπαθήσστε ξανά");
                continue;
            }
